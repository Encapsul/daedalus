...
//! restricts filesystem access to the daedalus cache and the app rootfs.
//!
...
/// - read/write/execute under the daedalus cache directory
...
pub fn apply_sandbox(rootfs: &Path) {
    let cache = dirs::cache_dir()
        ...
        .unwrap_or_else(|| "/Users/Shared/.cache/daedalus".to_string());
