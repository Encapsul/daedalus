...
daedalus build ./app -o app.ere \
  --enable-sisr --key …           ./app.ere --daedalus-update
...
DAEDALUS_UPDATE_URL=https://updates.example.com/my_app ./my_app.ere --daedalus-update
```
...
[daedalus] updated binary: /home/alice/app.ere
```
