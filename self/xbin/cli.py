...
def main(argv: list[str] | None = None) -> int:
    ...
    p_build.add_argument("--isolation", type=int, default=0, choices=[0, 1, 2],
    ...
    try:
        if args.command == "build":
            ...
            build(args.app, args.output, key_path=args.key, isolation=args.isolation, verbose=not args.quiet)
            return 0
