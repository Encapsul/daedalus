...
- CLI
  ...
  - [`xbin build --tree-shake`](https://tednoob17.github.io/x.bin/reference/builder.html) (remove unused node_modules)
  - [`xbin build --minify`](https://tednoob17.github.io/x.bin/reference/builder.html) (shrink JS/TS/CSS)
  - [`xbin build --include PATH`](https://tednoob17.github.io/x.bin/reference/builder.html) (embed data files)
  - [`xbin build --env-file .env`](https://tednoob17.github.io/x.bin/reference/builder.html) (bake environment variables)
  - [`xbin build --persist`](https://tednoob17.github.io/x.bin/reference/builder.html) (persistent storage)
  - [`xbin build --health-port 8081`](https://tednoob17.github.io/x.bin/reference/builder.html) (health checks)
  - [`xbin build --otel-endpoint URL`](https://tednoob17.github.io/x.bin/reference/builder.html) (OpenTelemetry)
  - [`xbin build --cron NAME:SCHEDULE`](https://tednoob17.github.io/x.bin/reference/builder.html) (scheduled tasks)
  - [`xbin build --version-info 1.0 --author "Name"`](https://tednoob17.github.io/x.bin/reference/builder.html) (metadata)
